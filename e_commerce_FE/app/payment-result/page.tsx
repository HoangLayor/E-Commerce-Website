    ...
    <div className="container mx-auto px-4 py-16 flex items-center justify-center min-h-[60vh]">
      <Card className="max-w-md w-full border-primary/10 shadow-xl overflow-hidden">
        <CardHeader className={`text-center py-10 ${
          isSuccess ? "bg-emerald-50" : isFail ? "bg-rose-50" : "bg-amber-50"
        }`}>
          ...
          <CardTitle className={`text-2xl font-serif font-bold ${
            isSuccess ? "text-emerald-700" : isFail ? "text-rose-700" : "text-amber-700"
          }`}>
        ...
        <CardFooter className="bg-muted/30 border-t py-4 justify-center">
          <p className="text-xs text-muted-foreground">
            Mọi thắc mắc vui lòng liên hệ hotline: <span className="font-semibold">1900 xxxx</span>
          </p>
        </CardFooter>
      </Card>
    </div>
