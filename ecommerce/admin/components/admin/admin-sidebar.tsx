...
const navigation = [
  ...
  { name: "Voucher", href: "/vouchers", icon: Tag },
  { name: "Flash Sale", href: "/promotions/flash-sale", icon: Sparkles },
  { name: "Tự động hóa AI", href: "/automation", icon: Cpu },
  { name: "Báo cáo", href: "/reports", icon: BarChart3 },
  { name: "Giao diện", href: "/pages", icon: Layers },
