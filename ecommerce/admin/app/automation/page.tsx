            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {orderId && (
                <div className="flex items-center gap-2">
                  ...
                  <Link href={`/orders/${orderId}`} target="_blank" className="text-xs flex items-center gap-1 bg-blue-50 text-blue-600 border border-blue-200 px-2 py-1 rounded-md hover:bg-blue-100 transition-colors">
